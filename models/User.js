...
const UserSchema = new mongoose.Schema({
    ...
    withdrawalAccount: { type: String, required: true, unique: true, trim: true },
    ...
    // حقول الدفع والسحب الآمنة الجديدة
    paymentMethod: { type: String, enum: ['CCP', 'BANK', 'PAYPAL', 'PAYEER'], default: 'CCP' },
    paymentAccount: { type: String }, // الحساب الفعلي الذي سيتم الدفع عليه
    withdrawalPassword: { type: String, default: null } // كلمة مرور السحب المشفرة
}, { timestamps: true });
